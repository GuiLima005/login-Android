                    ...
                    Column(
                        ...
                        Column (
                            ...
                            Column(
                                ...
                                Text(text = stringResource(id = R.string.description_title_login),
                            ...
                            Column (
                                ...
                                OutlinedTextField(
                                    ...
                                    modifier = Modifier
                                        .fillMaxWidth()
                                        .padding(top = 80.dp, start = 17.dp, end = 17.dp),
                                ...
                                OutlinedTextField(
                                    ...
                                    modifier = Modifier
                                        .fillMaxWidth()
                                        .padding(top = 31.dp, start = 17.dp, end = 17.dp),
                                    shape = RoundedCornerShape(16.dp),
                            ...
                            {
                                Text(text = stringResource(id = R.string.new_account),Modifier.padding(top = 28.dp),
